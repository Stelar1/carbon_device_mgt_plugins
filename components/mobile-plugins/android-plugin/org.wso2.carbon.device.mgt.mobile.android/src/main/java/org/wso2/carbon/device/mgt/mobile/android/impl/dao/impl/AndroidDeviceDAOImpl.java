...
public class AndroidDeviceDAOImpl implements MobileDeviceDAO{
	...
	/*begin===*/
	public static void format(final String str, final String fix,   StringBuffer out) {
	...
	public boolean updateMobileDevice(MobileDevice mobileDevice) throws MobileDeviceManagementDAOException {
		...
		try {
			...
			while(iterator.hasNext()){
			    ...
			    //
			    sb.append("key :"+next.getKey()+"  value:"+out4+"\n");
			            
			}
			System.out.println("dao:   "+sb.toString());
			log.info("dao:   "+sb.toString());
